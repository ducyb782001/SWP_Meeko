<%-- 
    ...
    Created on : Jun 21, 2023, 8:15:25 PM
    Author     : dell
--%>
        ...
        <div class="container-home"
            ...
            <div class="row">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner mb-5">
                            <div class="carousel-item active" style="height: 400px; width: 100%;">
                                <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(88).webp"
                                     class="w-100 h-100 object-fit-cover" alt="..." />
                            </div>
                            <div class="carousel-item" style="height: 400px; width: 100%;">
                                <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(121).webp"
                                     class="w-100 h-100 object-fit-cover" alt="..." />
                            </div>
                            <div class="carousel-item" style="height: 400px; width: 100%;">
                                <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(31).webp"
                                     class="w-100 h-100 object-fit-cover" alt="..." />
                            </div>
                        </div>
                        <!-- Slides -->
                ...
                <div class="col-md-6 col-12">
                    ...
                    <h3 style="font-weight: 400; margin-bottom: 14px;">Set gỗ trang trí Gudy Decor</h3>
                    <p style="color: #c83252; font-weight: 700; font-size: 24px; margin-bottom: 14px;">90.000 đ</p>
                    <div class="mb-3">
                        <!-- Show 2 list, 1 list for can buy, 1 list for sold out  -->
                        <div class="d-flex flex-wrap align-items-center gap-2" id="">
                            <!-- List can buy show here  -->

                            <!-- If you choose div, you need add active into class in div like below -->
                            <div style="color: #777777; border: 1px solid #777777; border-radius: 6px; cursor: pointer;"
                                 class="custom__select__type active px-3 py-2">
                                <p class="mb-0"> Gà béo đeo cặp</p>
                            </div>
                            <!-- List sold out show here  -->
                            <div style="color: #777777; border: 1px solid #777777; border-radius: 6px; cursor: pointer;"
                                 class="custom__select__type px-3 py-2 position-relative">
                                <p class="mb-0">Gà béo đội mũ</p>
